...
0.1.26 -  Sun Jan 21 08:45:23 2018 +0000
    ...
    config - useragent gdpvalue/version
    ...
    bugfix - gdpvaluevote - skip stale proposals

    style - gdpvaluevote - text edits


0.1.25 -  Sun Mar 26 05:00:38 2017 +0000

    enh - add .gdpvalue to path in .bash_aliases on install
    enh - better block sync check
    enh - better gdpvalued running detection
...
0.1.16 -  Tue Dec 29 05:41:43 2015 +0000
    ...
    bugfix - support gdpvalue.github.io downloads page shift to relative pathing

0.1.15 -  Thu Nov 26 02:57:45 2015 +0000

    update download url to dash.org
    bugfix - support stale nss lib - downgrade second gdpvalueninja attempt
...
0.1.13 -  Sun Oct 25 05:49:37 2015 +0000
    ...
    bugfix - fail gracefully when gdpvalueninja api offline
...
0.1.12 -  Tue Oct 20 21:14:51 2015 +0000
    ...
    bugfix - status - fail gracefully if gdpvalued not running
...
0.1.11 -  Wed Oct 14 08:19:10 2015 +0000
    ...
    bugfix - voting - fail gracefully when gdpvalue-cli not in path
...
0.1.10 -  Tue Oct 13 07:18:29 2015 +0000
    ...
    added gdpvalued uptime calculation
    added support for hot-node (Internet server) gdpvalue.conf voting
...
0.1.9 - Sun Oct 11 04:05:54 2015 +0000
    ...
    added gdpvaluevote - time-randomized voting, initial curses UI
...
0.1.8 - Mon Sep 14 02:59:05 2015 +0000
    ...
    bugfix - die if cannot determine latest-version from/retrieve gdpvalued downloads page
...
0.1.6 - Tue Sep 8 07:07:57 2015 +0000
    ...
    added gdpvalueninja masternode visibility
...
0.1.0 - Mon Sep 7 00:12:24 2015 +0000
    ...
    created new top-level script 'gdpvalueman'

    takes command line arguments:

        install
            - install latest gdpvalue executables (fresh install)
        reinstall
            - reinstall latest gdpvalue executables (overwrite existing)
        update
            - update to latest gdpvalue executables (update existing)
        sync
            - sync with github (git fetch/reset)
        restart
            - restarts (or starts) gdpvalued
...
0.0.8 - Thu Aug 27 07:57:15 2015 +0000
    ...
    added command line switches
        ...
        -h, --help
        -v, --version
    sync_gdpvalue_to_github.sh now pulls and sync's forced tags
